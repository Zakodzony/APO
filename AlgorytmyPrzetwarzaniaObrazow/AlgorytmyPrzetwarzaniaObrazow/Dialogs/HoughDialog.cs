...
{
    public partial class HoughDialog : Form
    {
        Bitmap image;
        Bitmap image2;
        Bitmap imgClone;
        Bitmap img2Clone;
        HoughFunctions functions = new HoughFunctions();
        ...
        private void HoughDialog_Load(object sender, EventArgs e)
        {
